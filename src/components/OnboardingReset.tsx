    ...
    return (
        <div className="min-h-screen bg-linear-to-br from-blue-50 to-purple-50 flex items-center justify-center p-8">
            <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
                <h1 className="text-3xl font-bold text-gray-900 mb-4">Reiniciar Onboarding</h1>
                <p className="text-gray-600 mb-6">
                    Esto borrará tu ubicación guardada y te permitirá volver a hacer el onboarding.
                </p>
                ...
                <div className="mt-8 p-4 bg-gray-50 rounded-lg">
                    <h3 className="font-bold text-sm text-gray-700 mb-2">Estado Actual:</h3>
                    <ul className="text-xs space-y-1 text-gray-600">
                        <li>Onboarding completado: {localStorage.getItem('onboarding_completed') ? '✅ Sí' : '❌ No'}</li>
                        <li>Ubicación guardada: {localStorage.getItem('user_location') ? '✅ Sí' : '❌ No'}</li>
                        <li>Municipio detectado: {localStorage.getItem('detected_municipality') ? '✅ Sí' : '❌ No'}</li>
                    </ul>
                </div>
            </div>
        </div>
