                ...
                {loading ? (
                  <div className="space-y-3">
                    {[1, 2, 3, 4, 5].map((i) => (
                      <div
                        key={i}
                        className="bg-white border border-primary-green/5 p-4 rounded-2xl animate-pulse"
                      >
                  ...
                  <div className="bg-white border border-primary-green/5 p-8 rounded-2xl text-center shrink-0">
                    <Search
                      size={40}
                      className="mx-auto mb-3 text-primary-green/20"
                    />
                    ...
                    <p className="text-xs text-primary-green/40 mb-3">
                      ...
                      {!searchQuery &&
                        selectedDepartment !== "Todos" &&
                        `Sin entidades en ${selectedDepartment}`}
                      {!searchQuery &&
                        selectedDepartment === "Todos" &&
                        selectedType !== "Todas" &&
                        `Sin entidades de tipo ${selectedType}`}
                    </p>
                    <ClearFiltersButton
                      onClear={() => {
                        setSearchQuery("");
