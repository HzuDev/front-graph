        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-[#f8f9fa] p-4">
                <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center border border-red-100">
                    ...
                    <p className="text-gray-600 mb-6">{error || 'Entidad no encontrada'}</p>
                    <a href="/" className="inline-flex items-center justify-center px-6 py-3 bg-[#14281d] text-white rounded-xl font-bold hover:opacity-90 transition-opacity w-full">
                        Volver al inicio
                    </a>
                </div>
            </div>
