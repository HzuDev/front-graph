          ...
          <div>
            ...
            {youtubeLink || socialLinks.length > 0 ? (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm font-black hover:underline truncate inline-block max-w-37.5"
              >
            ...
            {encuestas.length > 0 ? (
              encuestas.map((e) => (
                <a
                  key={e.id}
                  href={e.link || '#'}
                  className="group flex items-center justify-between p-8 bg-white border border-primary-green/5 rounded-[3.5rem] hover:border-primary-green transition-all"
                >
                  ...
                  <div className="flex items-center gap-4 shrink-0 mt-4 md:mt-0">
                    <span className="text-xs font-black bg-hunter px-3 py-1 rounded-full border border-primary-green/10 text-primary-green">
                      {e.fecha}
                    </span>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4 pt-6 border-t border-primary-green/5">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-[8px] font-black opacity-30 uppercase">
