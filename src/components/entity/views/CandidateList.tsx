        ...
        <div className="space-y-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-primary-green/5 pb-6 gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-3xl font-black tracking-tight" style={{ textWrap: "balance" }}>
                    ...
                    visibleCandidates.map((c) => (
                        ...
                        >
                            ...
                            <div className="pt-2">
                                ...
                                <h4 className="text-xl font-black leading-none mb-6 group-hover:text-primary-green pr-8" style={{ textWrap: "balance" }}>
                                    {c.nombre}
                                </h4>
                            </div>
            ...
            {hasMore && (
                <div ref={observerTarget} className="py-8 flex flex-col items-center justify-center gap-3">
                    <div className="flex gap-1">
                        <div className="w-2 h-2 rounded-full bg-primary-green animate-bounce" style={{ animationDelay: "0ms" }}></div>
                        <div className="w-2 h-2 rounded-full bg-primary-green animate-bounce" style={{ animationDelay: "150ms" }}></div>
                        <div className="w-2 h-2 rounded-full bg-primary-green animate-bounce" style={{ animationDelay: "300ms" }}></div>
                    </div>
                    <span className="text-[10px] uppercase font-black tracking-widest text-primary-green/40">Cargando resultados...</span>
                </div>
            )}
        </div>
    );
