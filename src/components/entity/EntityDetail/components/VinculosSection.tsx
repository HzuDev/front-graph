      ...
      <div className="space-y-3">
        {vinculosItems.length > 0 ? (
          vinculosItems.slice(0, 10).map((item) => (
            <div
              key={item.id}
              className="flex flex-col sm:flex-row sm:items-center justify-between p-6 rounded-[2rem] bg-primary-green/5 border border-transparent hover:border-primary-green/10 transition-all gap-4"
            >
